package com.example.homworkapp.Controller;

import com.example.homworkapp.Models.Products;
import com.example.homworkapp.Repository.ProductRepository;
import com.example.homworkapp.exception.ProductNotFoundException;
    ...
    public Products updateProduct(@RequestBody Products newProduct,
        ...
        return productRepository.findById(id)
                .map(product -> {
                    ...
                    product.setGenre(newProduct.getGenre());
