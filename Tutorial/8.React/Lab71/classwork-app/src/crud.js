    ...
    <div className = "container ">
      <div className = "row" >
        ...
        <form onSubmit={handleSubmit} >
            ...
            <input id="itemName" type="text" value={itemName} onChange={handleInputChange}/>
                ...
                <div className="row">
                    <div className="col-md-8">
                        <form onSubmit={handleSearch}>
                            ...
                            <input id="searchName" type="text" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />&nbsp;
